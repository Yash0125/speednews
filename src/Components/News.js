...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=90c5e34414014aaabc0835665c96380c&page=${page}&pageSize=${props.pageSize}`;
    setLoading(true);
  ...
  const fetchMoreData = async () => {
    const url = `https://newsapi.org/v2/top-headlines?country=${
      props.country
    }&category=${props.category}&apiKey=90c5e34414014aaabc0835665c96380c&page=${
      page + 1
